...
public class Piece {
	...
	*/
	...
	private void computeSkirt() {
		...
		for (TPoint point : this.body) {
			this.skirt[point.x] = Integer.min(this.skirt[point.x], point.y);
		}
	}
	...
	*/
	...
	public Piece computeNextRotation() {
		...
		for (int i = 0; i < body.length; i++) {
			TPoint point = this.body[i];
			points[i] = new TPoint(this.height - point.y - 1, point.x);
		}
	...
	*/
	public boolean equals(Object obj) {
		...
		return this.body.length == other.body.length
				&& Arrays.stream(other.body).allMatch(this::containsPoint);
	}
	
	private boolean containsPoint(TPoint point) {
		for (TPoint point1 : this.body) {
