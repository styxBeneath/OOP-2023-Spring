...
public class BoardTest extends TestCase {
	...
	public void testSuccessfulPlace() {
		...
		for (int i = 0; i < pieces.length; i++) {
			try {
				...
				assertEquals(Board.PLACE_COMMIT_PROBLEM_MESSAGE, e.getMessage());
			}
			board.commit();
		}
	...
	public void testDropHeight() {
		...
		try {
			...
			assertEquals(Board.INVALID_DROPPING_MESSAGE, e.getMessage());
		}
	}
